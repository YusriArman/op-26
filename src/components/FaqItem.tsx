...
function FAQItem({
  ...
  return (
    <div className="group p-[1px] rounded-xl bg-gradient-to-r from-[#3cf6f7]/50 via-[#e139fa]/50 to-[#6045f4]/50 shadow-[0_0_15px_rgba(0,0,0,0.3)] transition duration-300 hover:shadow-[0_0_20px_rgba(60,246,247,0.4)]">
      <div className="rounded-[11px] bg-[#090520]/90 backdrop-blur-md overflow-hidden">
        ...
        >
          <span className="text-base sm:text-lg font-futura-heavy font-bold text-[#3cf6f7] drop-shadow-[0_0_6px_rgba(60,246,247,0.5)] transition duration-200 group-hover:drop-shadow-[0_0_12px_rgba(60,246,247,0.9)]">
            {question}
          </span>
